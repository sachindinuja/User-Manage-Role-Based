...
function IneligibleReport({ terminationReportData }) {
  // console.log("Summary Report Data: ", terminationReportData);
  ...
  const data = terminationReportData
  ...
  const filteredItems = terminationReportData
    .sort((a, b) => b.employee_number.localeCompare(a.employee_number))
    .filter(
      (item) =>
        (filteringOptions.sales_month_filter === "ALL" ||
  ...
  const FilteredData = {
    sales_months: [
      "ALL",
      ...new Set(terminationReportData.map((item) => item.sales_month)),
    ],
    sales_persons: [
      "ALL",
      ...new Set(terminationReportData.map((item) => item.employee_number)),
    ],
    sales_channel: [
      "ALL",
      ...new Set(terminationReportData.map((item) => item.sales_chanal)),
    ],
    stages: [
      "ALL",
      ...new Set(terminationReportData.map((item) => item.calculation_type)),
    ],
  };
...
export default IneligibleReport;
